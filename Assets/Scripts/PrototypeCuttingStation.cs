...
public class PrototypeCuttingStation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        CheckPlayerItem();
        ObjectBeingCut = playerObject;
        ObjectBeingCutScript = ObjectBeingCut.GetComponent<CuttableIngredient>();
    ...
    public void PlaceItem()
    {
        ...
        // GameObject temp = Instantiate(playerObject, stationPosition, new Quaternion(0f, 0f, 0f, 0f), null);
